<aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li<?php if (isset($menu_promotor)) echo $menu_promotor; ?>><a href="<?php echo base_url(); ?>administradores/promotores/"><i class="fa fa-users"></i> <span>Promotores</span></a></li>
          <li<?php if (isset($menu_marca)) echo $menu_marca; ?>><a href="<?php echo base_url(); ?>administradores/marcas/"><i class="fab fa-bandcamp"></i> <span>Marcas</span></a></li>
          <li<?php if (isset($menu_tienda)) echo $menu_tienda; ?>><a href="<?php echo base_url(); ?>administradores/tiendas/"><i class="fa fa-shopping-bag"></i> <span>Tiendas</span></a></li>
